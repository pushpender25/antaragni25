...
//       <div className="grid 2xl:grid-cols-3  items-start m-1">
//         {/* === Left Column (Aftermovies player) === */}
//         <div className="flex justify-center items-center flex-col">
//           <h2
//             className={`${freehand.className} text-center text-5xl md:text-6xl font-bold text-yellow-300 mb-5`}
//           >
//             Aftermovies
//           </h2>
...
//         <div className="relative flex justify-center items-center py-4 mt-2 2xl:mt-30">
...
//         <div className="scene-content mx-1 my-2 p-4 max-w-5xl bg-black/50 backdrop-blur-lg border border-yellow-400/30 rounded-xl shadow-2xl ">
// 		<h2 className={`${freehand.className} text-5xl md:text-6xl text-center font-bold text-yellow-300 mb-4`}>
//          About Antaragni
//          </h2>
...
/* ======= AboutHome Component ======= */
export default function AftermoviesMob() {
  ...
  return (
    <AnimatedDiv>
      <div className="flex flex-col-reverse lg:flex-row justify-center items-start gap-8 px-6 md:px-12 lg:px-16 py-12 text-white">
        {/* LEFT SIDE */}
        <div className="lg:w-1/2 flex flex-col items-center lg:items-end border-t-0 lg:border-r-4 border-white pr-0 lg:pr-8">
        ...
        <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <p className="text-white/90 text-[1.1rem] leading-8 font-mooli mb-8">
            ...
            students from across India to celebrate culture and talent, serving
            as a global platform for artistic collaboration and exchange.
          </p>
